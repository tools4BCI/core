...
idasclient_setfidx(client, 1000);	% Client is at frame 1000
...
idmessage_setfidx(messageC, 1001);
...
idmessage_setfidx(messageF, 999);
...
idmessage_setfidx(messageD, 990);
...
while(true)
	...
	if(idasclient_getfidx(client) - idmessage_getfidx(message) > 1)
