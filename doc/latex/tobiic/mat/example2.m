...
for i = 1:100
	...
	icmessage_setfidx(ErrP.message, i);
	...
	fnErrP = icmessage_getfidx(Fusion.ErrP.message);
	if(fnEEG == fnErrP)
		icmessage_setfidx(Fusion.M.message, fnEEG);
	else
		disp('Error!');
	end
	...
	title(['Probabilities after merging - Frame ' ...
		num2str(icmessage_getfidx(Fusion.M.message))]);
